...
> **⚠️ Исторический документ.** Замечания из этого ревью уже частично или полностью исправлены в PR #71 (`260326-backend-refactoring-exchange`). Не использовать как актуальный источник для оценки состояния кода.
