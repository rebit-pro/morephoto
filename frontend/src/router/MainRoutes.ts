const MainRoutes = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import('@/views/forms/components/VOtpInput.vue')
    },
    {
      name: 'FileInput',
      path: '/components/file-input',
      component: () => import('@/views/forms/components/VFileInput.vue')
    },
    {
      name: 'Number Input',
      path: '/components/number-input',
      component: () => import('@/views/forms/components/VNumberInput.vue')
    },
    {
      name: 'Buttons',
    ...
    },
    {
      ...
      component: () => import('@/views/forms/components/VBottomSheet.vue')
    },
    {
      name: 'Autocomplete',
    ...
    },
    {
      ...
      component: () => import('@/views/forms/components/VRangeSlider.vue')
    },
    {
      name: 'Switch',
    ...
    {
      name: 'PieChart',
      path: '/forms/charts/piechart',
      component: () => import('@/views/forms/charts/pie-chart/PieChartPage.vue')
    },
    {
      name: 'Sparkline',
      path: '/forms/charts/sparklines',
      component: () => import('@/views/forms/charts/sparklines/SparklineChartPage.vue')
    },
    {
      name: 'Layouts',
    ...
    },
    {
      name: 'Parallax',
      path: '/basic/parallax',
      component: () => import('@/views/ui-elements/basic/UiParallax.vue')
    },
    {
      name: 'Badges',
      path: '/basic/badges',
    ...
    {
      name: 'Steppers',
      path: '/advance/steppers',
      component: () => import('@/views/ui-elements/advance/UiSteppers.vue')
    },
    {
      name: 'Ratings',
    ...
    {
      name: 'Maskinput',
      path: '/advance/mask-input',
      component: () => import('@/views/ui-elements/advance/UiMask.vue')
    },
    {
      name: 'Timeline',
    ...
    },
    {
      ...
      component: () => import('@/views/ui-elements/advance/treeview/UiTreeview.vue')
    },
    {
      name: 'Timepicker',
      path: '/advance/timepicker',
      component: () => import('@/views/ui-elements/advance/UiTimepicker.vue')
    },
    {
      name: 'Datepicker',
      path: '/advance/datepicker',
      component: () => import('@/views/ui-elements/advance/UiDatePicker.vue')
    },
    {
      name: 'Fileupload',
      path: '/advance/fileupload',
      component: () => import('@/views/ui-elements/advance/UiFileUpload.vue')
    },
    {
      name: 'Dataiterator',
      path: '/advance/data-iterator',
      component: () => import('@/views/ui-elements/advance/UiDataIterator.vue')
    },
    {
      name: 'Datatables',
      path: '/advance/basic-datatable',
      component: () => import('@/views/ui-elements/datatables/BasicDataTable.vue')
    },
    {
      name: 'Data&Display',
      path: '/advance/data-display-datatable',
      component: () => import('@/views/ui-elements/datatables/DataDisplayTable.vue')
    },
    {
      name: 'Serverside',
      path: '/advance/server-side-datatable',
      component: () => import('@/views/ui-elements/datatables/ServersideTable.vue')
    },
    {
      name: 'ButtonToggle',
    ...
    {
      name: 'ChipGroups',
      path: '/advance/chip-group',
      component: () => import('@/views/ui-elements/advance/UiChipGroups.vue')
    },
    {
      name: 'Tabler Icons',
      path: '/icons/tabler',
